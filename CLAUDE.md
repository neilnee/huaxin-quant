...
每日人工投研与持仓维护遵循 AGENTS.md 第 7、8 节：先完成分析讨论，再合并到 daily_research/YYYY-MM-DD.md，记录证据、分歧、修正与失效条件；以最近确认的券商持仓加后续确认交易维护连续基线。交易字段不完整时只记策略事实，不推断成交或写入正式账本；次日研究先回顾前序记录。
