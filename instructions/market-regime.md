...
市场整体趋势表以快速识别为目标：仅展示 1/5/20 日收益、阶段位置、趋势微图、短期趋势和 14 日平均波动。阶段位置以距 60 日高点的百分比计算：收盘处于 60 日新高时标记“60日新高”，否则标记浅回撤/中度回撤/深度回撤；趋势微图展示最近 20 日的价格、MA20、MA60 三条线，并附上行结构/回调观察/弱势结构标签，直观表现价格相对均线的位置、均线方向和收敛关系；短期趋势将 MA20 五日斜率转为上行/走平/下行箭头。表头居中，1/5/20 日收益列使用紧凑宽度。ATR14 在页面中称为“14日平均波动”，以每个宽基自身的波动风险分位标识低/中/高，并附原始百分比；量能比保留在数据包，不放入主表。
